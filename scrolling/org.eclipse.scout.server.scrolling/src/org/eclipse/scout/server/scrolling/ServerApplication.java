 ...
 * org.eclipse.equinox.http.jetty.context.path=/scoutScrolling_server
 ...
 * eclipse.product=org.eclipse.scout.server.scrolling.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("scoutScrolling server initialized");
    return EXIT_OK;
  }
